...
import 'package:aml/pages/signup_page.dart';
...
class LoginDialogNarrow extends StatefulWidget {
  LoginDialogNarrow({Key? key}) : super(key: key);

  @override
  State<LoginDialogNarrow> createState() => _LoginDialogNarrowState();
}

class _LoginDialogNarrowState extends State<LoginDialogNarrow> {
              ...
              children: [
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              icon: _isPassword
                                  ? Icon(Icons.visibility_off, color: (selected == User.password) ? enabledTxt : disabled, size: 20,)
                                  : Icon(Icons.visibility, color: (selected == User.password) ? enabledTxt : disabled, size: 20,),
                              onPressed: () => setState(() =>
                ...
                FadeAnimation(
                    ...
                    child: TextButton(
                      ...
                      child: Text('로그인', style: TextStyle(color: Colors.black, letterSpacing: 0.5, fontWeight: FontWeight.bold, fontSize:18),),
                    )
                ),
                SizedBox(
                  height: he * 0.03,
